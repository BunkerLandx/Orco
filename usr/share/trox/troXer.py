...
class RastreadorWeb:
    ...
    def cargar_estado(self):
        if os.path.exists(self.archivo_estado):
            with open(self.archivo_estado, "r") as f:
                ...
                self.profundidad_max = estado.get("profundidad_max", self.profundidad_max)
                self.retraso = estado.get("retraso", self.retraso)
    ...
    def guardar_estado(self):
        ...
        with open(self.archivo_estado, "w") as f:
            js.dump(estado, f)
        self.imprimir_verbose("Estado detallado guardado en el archivo.")
    ...
    def extraer_enlaces(self, html, url_base, profundidad):
        ...
        for enlace in sopa.find_all("a", href=True):
            ...
            if url_completa not in self.urls_visitadas:
                ...
                enlaces_extraidos.append(url_completa)
    ...
    def iniciar_rastreo(self):
        ...
        self.imprimir_verbose("Iniciando rastreo web...")
